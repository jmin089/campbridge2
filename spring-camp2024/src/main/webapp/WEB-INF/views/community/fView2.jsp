...
<html>
	<head>
		...
		<link href="../assets/css/commuinty/viewStyle2.css" rel="stylesheet">
	</head>
	<body>
	<!-- ======= Header ======= -->
		...
		<section class="notice">
		    ...
		    <table>
		     <colgroup>
		      ...
		      <tr>
		        <th style="text-align: center;"><strong>${map.fdto2.f_bno }</strong></th>
		        <th style="text-align: left;"><span>${map.fdto2.f_btitle }</span></th>
		        <th style="text-align: right;"><strong>작성일</strong></th>
		        <th><fmt:formatDate value="${map.fdto2.f_bdate }" pattern="yyyy-MM-dd"/></th>
		      </tr>
		      <tr style="border-bottom: 2px solid #009223">
		        ...
		        <td>${map.fdto2.f_bhit }</td>
		      </tr>
		      <tr>
		        <td colspan="4" class="article">${map.fdto2.f_bcontent }<br><br><br><br><br></td>
		      </tr>
		       <tr style="border-bottom: 2px solid #009223;">
		        <td class="article" style="text-align: center;"><strong>첨부파일 </strong>
		        </td>
		        <td colspan="3">${map.fdto2.f_bfile }</td>
		      </tr>
		    </table>
		    ...
		    <div class="listBtn">
		    	...
		    	<a href="fList2"><button class="list">목록</button></a>
		    </div>
		    ...
		    <table style="margin-top: -150px; ">
		      <tr>      
		        ...
		        <c:if test="${map.nextfdto2 != null}">
		        <a href="fView2?f_bno=${map.nextfdto2.f_bno }">${map.nextfdto2.f_btitle }</a>
		        </c:if>
		        <c:if test="${map.nextfdto2 == null}">
		        다음글이 없습니다.
		        </c:if>
		      ...
		      <tr>
		        ...
		        <c:if test="${map.prefdto2 != null}">
		        <a href="fView2?f_bno=${map.prefdto2.f_bno }">${map.prefdto2.f_btitle }</a>
		        </c:if>
		        <c:if test="${map.prefdto2 == null}">
		        이전글이 없습니다.
		        </c:if>
