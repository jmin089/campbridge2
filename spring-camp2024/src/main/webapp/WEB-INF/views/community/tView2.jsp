		...
		<section class="notice">
		    ...
		    <table>
		     <colgroup>
		      ...
		      <tr>
		        <th style="text-align: center;"><strong>${map.tdto2.t_bno }</strong></th>
		        <th style="text-align: left;"><span>${map.tdto2.t_btitle }</span></th>
		        <th style="text-align: right;"><strong>작성일</strong></th>
		        <th><fmt:formatDate value="${map.tdto2.t_bdate }" pattern="yyyy-MM-dd"/></th>
		      </tr>
		      <tr style="border-bottom: 2px solid #009223">
		        ...
		        <td>${map.tdto2.t_bhit }</td>
		      </tr>
		      <tr>
		        <td colspan="4" class="article">${map.tdto2.t_bcontent }<br><br><br><br><br></td>
		      </tr>
		       <tr style="border-bottom: 2px solid #009223;">
		        <td class="article" style="text-align: center;"><strong>첨부파일 </strong>
		        </td>
		        <td colspan="3">${map.tdto2.t_bfile }</td>
		      </tr>
		    </table>
		    ...
		    <div class="listBtn">
		    	...
		    	<a href="tList2"><button class="list">목록</button></a>
		    </div>
