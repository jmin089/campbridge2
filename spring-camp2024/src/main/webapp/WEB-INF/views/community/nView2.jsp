		...
		<section class="notice">
		    ...
		    <table>
		     <colgroup>
		      ...
		      <tr>
		        <th style="text-align: center;"><strong>${map.ndto2.n_bno }</strong></th>
		        <th style="text-align: left;"><span>${map.ndto2.n_btitle }</span></th>
		        <th style="text-align: right;"><strong>작성일</strong></th>
		        <th><fmt:formatDate value="${map.ndto2.n_bdate }" pattern="yyyy-MM-dd"/></th>
		      </tr>
		      <tr style="border-bottom: 2px solid #009223">
		        ...
		        <td>${map.ndto2.n_bhit }</td>
		      </tr>
		      <tr>
		        <td colspan="4" class="article">${map.ndto2.n_bcontent }<br><br><br><br><br></td>
		      </tr>
		       <tr style="border-bottom: 2px solid #009223;">
		        <td class="article" style="text-align: center;"><strong>첨부파일 </strong>
		        </td>
		        <td colspan="3">${map.ndto2.n_bfile }</td>
		      </tr>
		    </table>
		    ...
		    <div class="listBtn">
		    	...
		    	<a href="nList2"><button class="list">목록</button></a>
		    </div>
		    ...
		    <table style="margin-top: -150px; ">
		      <tr>      
		        ...
		        <c:if test="${map.nexttdto != null}">
		        <a href="tView?t_bno=${map.nexttdto.t_bno }">${map.nexttdto.t_btitle }</a>
		        </c:if>
		        <c:if test="${map.nexttdto == null}">
		        다음글이 없습니다.
		        </c:if>
		      ...
		      <tr>
		        ...
		        <c:if test="${map.pretdto != null}">
		        <a href="fView?f_bno=${map.pretdto.t_bno }">${map.pretdto.t_btitle }</a>
		        </c:if>
		        <c:if test="${map.pretdto == null}">
		        이전글이 없습니다.
		        </c:if>
